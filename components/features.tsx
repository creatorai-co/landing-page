      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            More Features Announcing Soon...
            </h2>
            <p className="text-lg text-indigo-200/65">
            If you have feature requests, need more information about the platform, or are interested in contributing, we'd love to hear from you.
            </p>
          </div>
          <div className="flex justify-center pb-2 md:pb-2" data-aos="fade-up">
            <Image
              className="max-w-none"
              src={FeaturesImage}
              width={1104}
